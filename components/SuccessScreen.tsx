      ...
      <div className="max-w-lg w-full space-y-10 md:space-y-16 relative z-10">
        ...
        <div className="bg-white rounded-[2rem] md:rounded-[3rem] p-8 md:p-14 shadow-2xl relative overflow-hidden group border-t-8 md:border-t-[12px] border-[#d4567f]">
          ...
          <button 
            ...
            className={`w-full py-4 md:py-6 rounded-2xl md:rounded-3xl font-cinzel font-black text-base md:text-xl transition-all flex items-center justify-center gap-3 uppercase tracking-[0.1em] md:tracking-[0.2em] shadow-lg ${
              copied ? 'bg-green-500 text-white scale-95' : 'bg-[#fff5f9] text-[#d4567f] border-2 border-[#f8c6d8] hover:bg-[#d4567f] hover:text-white hover:border-[#d4567f] active:scale-95'
            }`}
          >
            {copied ? '✓ Token Secured' : '📋 Copy Access Key'}
          </button>
        </div>
        ...
        <div className="glass-card p-8 md:p-12 rounded-[2rem] md:rounded-[2.5rem] text-left space-y-6 md:space-y-8 shadow-xl border border-white/10">
          ...
          <div className="space-y-6 md:space-y-8">
            <div className="flex gap-4 md:gap-6 items-start">
              ...
              <p className="font-josefin text-white text-sm md:text-base leading-relaxed font-light italic opacity-90">Privately share this 6-digit key with your beloved.</p>
            </div>
            <div className="flex gap-4 md:gap-6 items-start">
              ...
              <p className="font-josefin text-white text-sm md:text-base leading-relaxed font-light italic opacity-90">Direct them to this portal to witness the unfold.</p>
            </div>
            <div className="flex gap-4 md:gap-6 items-start">
